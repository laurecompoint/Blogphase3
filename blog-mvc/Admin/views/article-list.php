			...
			<div class="row my-3 index-content">
				...
				<section class="col-9">
					<header class="pb-4 d-flex justify-content-between">
						...
						<a class="btn btn-primary" href="index.php?pageadmin=article-form">Ajouter un article</a>
					</header>
					...
					<table class="table table-striped">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a href="index.php?pageadmin=article-form?article_id=<?php echo $article['id']; ?>&action=edit" class="btn btn-warning">Modifier</a>
